...
#define HW_TIMER_INTERVAL_MS =(1/HW_FREQ)*1000 //Time period of the timer to trigger the interrupt, in milliseconds
...
void setup() {
  analogReference(AR_INTERNAL_3_0); //Set the analog reference voltage to VDD (3.3 V)
  ...
  ISR_Timer.setInterval(TIMER_INTERVAL_1S,  SampleEOG);
}
